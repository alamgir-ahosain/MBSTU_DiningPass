...
export const HallAdminProfile = () => {
    ...
    const loadProfile = async () => {
        ...
        setError('');
        try {
            const response = await hallAdminAPI.getMyProfile();
            ...
            console.error('Failed to load hall admin profile', err);
    ...
    const handleSubmit = async (event) => {
        ...
        setSuccess('');
        try {
            await hallAdminAPI.updateMyProfile(formData);
            setSuccess('Profile updated successfully.');
            await loadProfile();
        } catch (err) {
            console.error('Failed to update hall admin profile', err);
            ...
            <div className="card">
                ...
                {loading ? (
                    ...
                    <>
                        <div className="detail-grid" style={{ marginBottom: '1.5rem' }}>
                            ...
                            <div className="detail-card">
                                ...
                                <span className="detail-value">{profile.role || 'HALL_ADMIN'}</span>
                            </div>
                            <div className="detail-card">
                        ...
                        <div className="profile-security-section">
                            ...
                            <div className="button-group profile-actions">
                                <Link to="/hallAdmin/change-password" className="btn btn-primary">Change Password</Link>
                                <Link to="/hallAdmin/forgot-password" className="btn btn-cancel">Forgot Password</Link>
                            </div>
                        </div>
                    </>
                ) : (
                    <div className="empty-state">
                        ...
                        <p>Could not load Hall Admin profile details.</p>
                    </div>
                )}
            </div>
        </div>
