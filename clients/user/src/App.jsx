...
import { PaymentHistroryPage } from './pages/Student/payment/PaymentHistroryPage';
                ...
                <div className="app">
                    ...
                    <main className="app-main">
                        <Routes>
                            ...
                            {/* ── bKash Payment Result Pages ──────────────────
                                These are PUBLIC — no ProtectedRoute.
                                bKash (via the backend redirect) navigates the browser
                                here without a JWT in the URL. The student is still
                                logged in (JWT stored in memory/localStorage).
                            ─────────────────────────────────────────────────── */}
                            <Route path="/payment/success" element={<PaymentSuccessPage />} />
                            <Route path="/payment/failure" element={<PaymentFailurePage />} />

                            {/* NOTE: /payment/callback is REMOVED.
                                bKash now calls the BACKEND callback URL:
                                  GET http://localhost:8082/api/payment/bkash/callback
                                The backend runs executePayment() and then redirects
                                the browser to /payment/success or /payment/failure above.
                                There is no React callback page anymore. */}
                            ...
                            <Route path="/student/payment-history"
                                element={<ProtectedRoute requiredRole="STUDENT"><PaymentHistroryPage /></ProtectedRoute>} />

                            {/* bKash payment entry point — both paths go to same page */}
                            <Route path="/student/cut-token"
                                element={<ProtectedRoute requiredRole="STUDENT"><BkashPaymentPage /></ProtectedRoute>} />
                            <Route path="/student/bkash-payment"
                                element={<ProtectedRoute requiredRole="STUDENT"><BkashPaymentPage /></ProtectedRoute>} />

                            {/* ── Hall Admin Routes ────────────────────────── */}
                            <Route path="/hallAdmin/dashboard"
                                element={<ProtectedRoute requiredRole="HALL_ADMIN"><HallAdminDashboard /></ProtectedRoute>} />
                            <Route path="/hallAdmin/staff"
                                element={<ProtectedRoute requiredRole="HALL_ADMIN"><HallAdminStaff /></ProtectedRoute>} />
                            <Route path="/hallAdmin/students"
                                element={<ProtectedRoute requiredRole="HALL_ADMIN"><HallAdminStudents /></ProtectedRoute>} />
                            <Route path="/hallAdmin/meals"
                                element={<ProtectedRoute requiredRole="HALL_ADMIN"><HallAdminMealConfigs /></ProtectedRoute>} />
                            <Route path="/hallAdmin/payments"
                                element={<ProtectedRoute requiredRole="HALL_ADMIN"><HallAdminPayments /></ProtectedRoute>} />
                            <Route path="/hallAdmin/profile"
                            ...
                            <Route path="/hallStaff/dashboard"
                                element={<ProtectedRoute requiredRole="HALL_STAFF"><HallStaffDashboard /></ProtectedRoute>} />
                            <Route path="/hallStaff/payments"
                                element={<ProtectedRoute requiredRole="HALL_STAFF"><HallStaffPayments /></ProtectedRoute>} />
                            <Route path="/hallStaff/meals"
                                element={<ProtectedRoute requiredRole="HALL_STAFF"><HallStaffMealConfigs /></ProtectedRoute>} />
                            <Route path="/hallStaff/summary"
                                element={<ProtectedRoute requiredRole="HALL_STAFF"><HallMealSummary /></ProtectedRoute>} />
                            <Route path="/hallStaff/profile"
                            ...
                            <Route path="/superAdmin/create-hall"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><CreateHall /></ProtectedRoute>} />
                            <Route path="/superAdmin/create-admin"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><CreateAdmin /></ProtectedRoute>} />
                            <Route path="/superAdmin/forgot-password"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><SuperAdminForgotPassword /></ProtectedRoute>} />
                            <Route path="/superAdmin/halls"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><SuperAdminHalls /></ProtectedRoute>} />
                            <Route path="/superAdmin/halls/:id"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><SuperAdminHallDetails /></ProtectedRoute>} />
                            <Route path="/superAdmin/halls/:id/edit"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><SuperAdminEditHall /></ProtectedRoute>} />
                            <Route path="/superAdmin/admins"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><SuperAdminAdmins /></ProtectedRoute>} />
                            <Route path="/superAdmin/admins/:id"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><SuperAdminAdminDetails /></ProtectedRoute>} />
                            <Route path="/superAdmin/profile"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><SuperAdminProfile /></ProtectedRoute>} />
                            <Route path="/superAdmin/change-password"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><SuperAdminChangePassword /></ProtectedRoute>} />
                            <Route path="/superAdmin/students"
                                element={<ProtectedRoute requiredRole="SUPER_ADMIN"><SuperAdminStudents /></ProtectedRoute>} />
